...
public class RenegociacaoRequestClient {
    ...
    public RenegociacaoRequestClient(@NotBlank String identificadorDaFatura, @NotBlank int quantidade, @NotBlank BigDecimal valor) {
